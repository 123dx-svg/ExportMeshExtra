...
{
public:
	explicit FThumbnailExporterScene(const FThumbnailCreationConfig& InThumbnailCreationConfig);
	...
	//设置Config
	void SetThumbnailCreationConfig(const FThumbnailCreationConfig& InThumbnailCreationConfig);
	//获取Config
	const FThumbnailCreationConfig& GetThumbnailCreationConfig() const { return ThumbnailCreationConfig; }
	...
	void UpdatePreviewActorComponents();
...
protected:
	...
	// The thumbnail creation config that was used to create this scene
	FThumbnailCreationConfig ThumbnailCreationConfig;
